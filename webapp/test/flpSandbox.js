		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Location Product Unique &amp; Primary ID",
									"targetURL": "#vcpappvcplocproduniqid-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"vcpappvcplocproduniqid-display": {
								"semanticObject": "vcpappvcplocproduniqid",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=vcpapp.vcplocproduniqid",
									"url": sap.ui.require.toUrl("vcpapp/vcplocproduniqid")
								}
							}
						}
					}
